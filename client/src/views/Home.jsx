    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="max-w-6xl mx-auto mt-10 px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl shadow-xl border border-[#CBD5E1] p-6">
          ...
          {!token && (
            <p className="text-gray-500">Please login to create and view your tours.</p>
          )}

          {token && loading && <p className="text-gray-500">Loading tours...</p>}

          {token && !loading && tours.length === 0 && (
