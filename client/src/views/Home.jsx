...
function Home() {
  ...
  return (
    <div className="min-h-screen page-bg transition-colors duration-300">
      ...
      {/* Features Section */}
      <section id="features" className="py-20 page-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-primary mb-4">Why Choose TineyTours?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="surface p-8 rounded-3xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-surface">
              ...
              <h3 className="text-2xl font-semibold text-primary mb-4">Plan Your Journeys</h3>
            ...
            <div className="surface p-8 rounded-3xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-surface">
              ...
              <h3 className="text-2xl font-semibold text-primary mb-4">Capture Memories</h3>
              <p className="text-muted">
            ...
            <div className="surface p-8 rounded-3xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-surface">
              ...
              <h3 className="text-2xl font-semibold text-primary mb-4">Share Your Stories</h3>
              <p className="text-muted">
